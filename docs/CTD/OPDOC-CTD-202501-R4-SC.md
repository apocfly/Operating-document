...
2.16 提前取消：管制员在报名活动席位后，如果有个人情况需要取消报名者，需提前24小时取消报名；若不能提前24小时取消，需寻找顶班管制员；或与上级席位协调且上级席位同意后，才可取消报名；若违反上述规定，管制员训练部将严肃处理。

2.17 保证一定活跃：最低活跃度标准，管制员每60天内至少上线30小时。
...
!!! Note
    ...
    例如：
    ```
    [S3 Under Mentoring] Training in progress, mentored by ZBAA_I_APP.
    ```
...
!!! Note
    ...
    例如：
    ```
    [S3 Solo] Certification expires on 2077.02.31
    ```
